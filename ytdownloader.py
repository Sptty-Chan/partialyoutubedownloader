...
os.system(f"ffmpeg -ss {start} -to {end} -i /content/outputTmp.mp4 -c copy /content/gdrive/MyDrive/output-{namaFileVideo}.mp4")
os.system("rm -rf /content/outputTmp.mp4")
print("Selesai..")
print("Silahkan download file anda di google drive")
print(f"File anda bernama output-{namaFileVideo}.mp4")
